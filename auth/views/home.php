...
<style>
    /* Smooth Scroll para sa buong page */
    html {
        scroll-behavior: smooth;
    }

    /* Yung line style na parang sa mission/vision */
    .flow-line {
        width: 2px;
        height: 80px;
    ...
    <main>
            ...
            <div class="relative z-10 px-6 w-full max-w-4xl mx-auto text-center">
                <div class="p-8 md:p-12 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 shadow-2xl">
                    ...
                    <h2 class="text-3xl md:text-6xl font-black text-white leading-tight uppercase tracking-tighter mb-6">
                        Connecting Alumni<br>Empowering Futures
                    </h2>
        ...
        <section class="py-15 px-6 max-w-7xl mx-auto">
            ...
            <div class="grid md:grid-cols-3 gap-10">
                ...
                <div class="p-10 bg-white shadow-xl rounded-xl border-b-4 border-[#c59dd9] transition-all duration-300 cursor-pointer group"
                    data-aos="fade-up"
                    data-aos-delay="100">
                ...
                <div class="p-10 bg-white shadow-xl rounded-xl border-b-4 border-[#7a3f91] transition-all duration-300 cursor-pointer group"
                    data-aos="fade-up"
                    data-aos-delay="300">
                ...
                <div class="p-10 bg-white shadow-xl rounded-xl border-b-4 border-[#2b0d3e] transition-all duration-300 cursor-pointer group"
                    data-aos="fade-up"
                    data-aos-delay="500">
        ...
        <div class="max-w-7xl mx-auto grid md:grid-cols-3 gap-12 border-b border-white/10 pb-12 mb-20 text-center md:text-left">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center justify-center md:justify-start space-x-3 transition-all hover:text-[#c59dd9] group">
                    <i class="fa-brands fa-facebook text-3xl text-[#c59dd9] transition-transform"></i>
